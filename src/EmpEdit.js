...
const EmpEdit = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:3000/employee/" + empid)
            ...
            .then((resp) => {
                ...
                datechange(resp.date); // Add this line to set the date state
            })
            .catch((err) => {
    ...
    const [date, datechange] = useState(""); // Add state for the date
    ...
    const handlesubmit = (e) => {
        ...
        fetch(`http://localhost:3000/updateemployee/${empid}`, {
            method: "PUT",
